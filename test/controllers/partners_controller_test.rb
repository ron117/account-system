...
class PartnersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create partner" do
    assert_difference('Partner.count') do
      post partners_url, params: { partner: { address: @partner.address, designation: @partner.designation, email: @partner.email, name: @partner.name, phone: @partner.phone } }
    end
  ...
  test "should update partner" do
    patch partner_url(@partner), params: { partner: { address: @partner.address, designation: @partner.designation, email: @partner.email, name: @partner.name, phone: @partner.phone } }
