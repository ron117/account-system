...
class TranscriptsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create transcript" do
    assert_difference('Transcript.count') do
      post transcripts_url, params: { transcript: { credit: @transcript.credit, debit: @transcript.debit, description: @transcript.description, transaction_type: @transcript.transaction_type } }
    end
  ...
  test "should update transcript" do
    patch transcript_url(@transcript), params: { transcript: { credit: @transcript.credit, debit: @transcript.debit, description: @transcript.description, transaction_type: @transcript.transaction_type } }
